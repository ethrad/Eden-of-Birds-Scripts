...
namespace Tycoon
{
    public class TutorialKitchenPlateController : MonoBehaviour, IDropHandler
    {
        ...
        public GameObject panel6Cursor;

        public GameObject crowTitSeat;
        TutorialNormalSeatController crowTitSeatController;
        
        public List<GameObject> tempIngredients = new List<GameObject>();
        ...
        public void OnDrop(PointerEventData eventData)
        {
            if (canDrop == true)
            {
                ...
                if (TutorialTycoonManager.instance.panelNum == 5)
                {
                    if (tempIngredients[0].name == "slimeMucus")
                    {
                        ...
                        panel6Cursor.SetActive(true);
                        panelObj1.SetActive(false);
                    }
                }

                if (TutorialTycoonManager.instance.panelNum == 6)
                {
                    if (tempIngredients.Count >= 2)
                    {
                        panelObj.SetActive(false);
                        panel6Cursor.SetActive(false);
                        panelObj1.SetActive(true);
                    }
                }
                
                if (TutorialTycoonManager.instance.panelNum == 10)
                {
                    if (tempIngredients[2].name == "bigLeaf")
                    {
                        TutorialTycoonManager.instance.panelObj.SetActive(false);
                        TutorialTycoonManager.instance.panelObj1.SetActive(false);
                        if (tempIngredients.Count >= 4)
                        {
                            TutorialTycoonManager.instance.panelNum++;
                            TutorialTycoonManager.instance.SetActivePanel(TutorialTycoonManager.instance.panelNum);
                        }
                ...
                if (TutorialTycoonManager.instance.rabbitPanelNum == 5)
                {
                    if (tempIngredients[4].name == "rabbitMeat")
                    {
                ...
                else if (TutorialTycoonManager.instance.rabbitPanelNum == 6)
                {
                    if (tempIngredients[5].name == "stem")
                    {
                        TutorialTycoonManager.instance.rabbitPanelNum++;
                        TutorialTycoonManager.instance.SetActiveRabbitPanel(TutorialTycoonManager.instance.rabbitPanelNum);
                    }
                }
                else if (TutorialTycoonManager.instance.rabbitPanelNum == 7)
                {
                    if (tempIngredients[6].name == "slimeMucus")
                    {
                        TutorialTycoonManager.instance.rabbitPanelNum++;
                        TutorialTycoonManager.instance.SetActiveRabbitPanel(TutorialTycoonManager.instance.rabbitPanelNum); 
                    }
        ...
        public void OnServiceBellClicked()
        {
            ...
            if (TutorialTycoonManager.instance.rabbitPanelNum == 8)
            {
                TutorialTycoonManager.instance.rabbitPanelNum++;
                TutorialTycoonManager.instance.SetActiveRabbitPanel(TutorialTycoonManager.instance.rabbitPanelNum);
            }
            ...
            if (ingredients.Count > 0)
            {
                ...
                crowTitSeatController.foodName = recipeName;
                ingredients.Clear();
        ...
        {
            bool servingResult = TutorialTycoonManager.instance.GetServed(recipeName);
        ...
        void Start()
        {
            ...
            crowTitSeatController = crowTitSeat.GetComponent<TutorialNormalSeatController>();
        }
    }
}